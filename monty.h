...
void printStringFromStack(stack_t **head, unsigned int counter);
...
void rotateRight(stack_t **head, __attribute__((unused)) unsigned int counter);
void switchToStackMode(stack_t **head, unsigned int counter);
